...
<div class="ein-page">
    <div class="ein-container">
        ...
        <div class="ein-welcome">
            <h2>Lupa Password</h2>
            <p>Masukkan alamat email Anda, kami akan kirimkan link untuk reset password.</p>
        </div>

        <div class="ein-card">
            <div class="ein-card-top"></div>
            <div class="ein-card-body">
                <x-auth-session-status class="ein-status" :status="session('status')" />
                ...
                <form method="POST" action="{{ route('password.email') }}">
                    ...
                    <a href="{{ route('login') }}" class="ein-btn-outline">Kembali ke Login</a>
                </form>
            </div>
        </div>
...
.ein-status{margin-bottom:14px;font-size:12px;color:var(--ein-teal);font-weight:600;}
...
.ein-btn-primary,.ein-btn-outline{position:relative;isolation:isolate;overflow:visible;width:100%;}
.ein-btn-primary{padding:14px;border:none;border-radius:12px;background:linear-gradient(135deg,#14B8A6,#0d9488);color:#fff;font-family:'Poppins',sans-serif;font-weight:600;font-size:13.5px;display:flex;align-items:center;justify-content:center;gap:8px;cursor:pointer;box-shadow:0 12px 22px -10px rgba(20,184,166,.45);transition:box-shadow .3s;}
...
.ein-divider{position:relative;text-align:center;margin:18px 0;}
