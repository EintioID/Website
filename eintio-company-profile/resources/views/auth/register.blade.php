...
<div class="ein-bg-fixed">
    ...
    <div class="shape blob" style="width:34vw;height:34vw;max-width:380px;max-height:380px;background:#c6a15b;top:55%;right:-12vw;opacity:.14;animation-duration:19s;animation-delay:-4s;"></div>
    ...
    <div class="shape blob" style="width:20vw;height:20vw;max-width:220px;max-height:220px;background:#c6a15b;top:30%;left:52%;opacity:.07;animation-duration:23s;animation-delay:-7s;"></div>

    <div class="shape spin" style="width:110px;height:110px;border:2px solid #14B8A6;border-radius:28px;top:14%;left:9%;opacity:.22;animation-duration:24s;"></div>
    <div class="shape spin" style="width:80px;height:80px;border:2px dashed #41526D;border-radius:50%;bottom:8%;right:8%;opacity:.18;animation-duration:32s;"></div>
    <div class="shape spin" style="width:56px;height:56px;border:2px solid #c6a15b;border-radius:16px;bottom:34%;left:6%;opacity:.2;animation-duration:27s;animation-direction:reverse;"></div>

    <div class="shape drift" style="width:64px;height:64px;border:2px solid #c6a15b;border-radius:50%;top:18%;right:10%;opacity:.28;animation-duration:9s;"></div>
    <div class="shape drift" style="width:14px;height:14px;background:#14B8A6;border-radius:50%;top:38%;left:20%;opacity:.5;animation-duration:7s;"></div>
    <div class="shape drift" style="width:10px;height:10px;background:#c6a15b;border-radius:50%;top:58%;right:20%;opacity:.5;animation-duration:8s;animation-delay:-2s;"></div>
    <div class="shape drift" style="width:18px;height:18px;background:#41526D;border-radius:6px;bottom:16%;right:28%;opacity:.3;animation-duration:11s;animation-delay:-3s;"></div>
    <div class="shape drift" style="width:12px;height:12px;background:#14B8A6;border-radius:50%;bottom:44%;left:15%;opacity:.4;animation-duration:10s;animation-delay:-5s;"></div>

    <div class="icon-float drift" style="top:16%;right:22%;color:#14B8A6;opacity:.3;animation-duration:10s;">
    ...
    <div class="icon-float drift" style="bottom:26%;left:10%;color:#c6a15b;opacity:.3;animation-duration:12s;animation-delay:-3s;">
    ...
    <div class="icon-float drift" style="top:60%;right:9%;color:#41526D;opacity:.25;animation-duration:11s;animation-delay:-5s;">
    ...
    <div class="icon-float spin" style="top:5%;left:42%;color:#c6a15b;opacity:.18;animation-duration:28s;">
    ...
    <div class="icon-float drift" style="bottom:6%;left:44%;color:#14B8A6;opacity:.22;animation-duration:13s;animation-delay:-2s;">
...
<div class="ein-page">
    <div class="ein-container">
        <div class="ein-header">
            <div class="ein-logo" style="background:linear-gradient(135deg,#c6a15b,#14B8A6);">
        ...
        <div class="ein-welcome">
            ...
            <p>Daftarkan akun untuk kelola konten website perusahaan</p>
        </div>

        <div class="ein-card">
            <div class="ein-card-top" style="background:linear-gradient(90deg,#c6a15b,#14B8A6,#41526D);"></div>
            <div class="ein-card-body">
                <form method="POST" action="{{ route('register') }}">
                    ...
                    <div class="ein-field">
                        ...
                        <x-input-error :messages="$errors->get('name')" class="ein-error" />
                    </div>
                    ...
                    <div class="ein-field">
                        ...
                        <div class="ein-input-wrap">
                            <span class="ein-input-icon">
                                <svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5">
                                    <path d="M21 4H3c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h18c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2z"/>
                                    <path d="m3 6 9 6 9-6" stroke-linecap="round" stroke-linejoin="round"/>
                                </svg>
                            </span>
                            <input id="email" type="email" name="email" value="{{ old('email') }}" required placeholder="nama@email.com"/>
                        </div>
                        <x-input-error :messages="$errors->get('email')" class="ein-error" />
                    </div>
                    ...
                    <div class="ein-field">
                        ...
                        <x-input-error :messages="$errors->get('password_confirmation')" class="ein-error" />
                    </div>

                    <button type="submit" class="ein-btn-primary" style="background:linear-gradient(135deg,#c6a15b,#14B8A6);">
                    ...
                    <div class="ein-divider"><span>atau</span></div>

                    <a href="{{ route('login') }}" class="ein-btn-outline">Sudah punya akun? Masuk</a>
                </form>
            </div>
        </div>
...
.ein-logo{width:52px;height:52px;border-radius:16px;margin:0 auto 10px;display:flex;align-items:center;justify-content:center;box-shadow:0 12px 24px -10px rgba(198,161,91,.4);animation:floaty 4s ease-in-out infinite;}
...
.ein-card-top{height:4px;}
.ein-card-body{padding:clamp(18px,5vw,26px);}

.ein-field{margin-bottom:12px;}
...
.ein-btn-primary,.ein-btn-outline{position:relative;isolation:isolate;overflow:visible;width:100%;margin-top:6px;}
.ein-btn-primary::before,.ein-btn-primary::after,
.ein-btn-outline::before,.ein-btn-outline::after{
  content:"";position:absolute;width:12px;height:12px;
  border-color:var(--ein-gold);opacity:0;transition:all .35s cubic-bezier(.4,0,.2,1);
}
.ein-btn-primary::before,.ein-btn-outline::before{top:0;left:0;border-top:2px solid;border-left:2px solid;transform:translate(6px,-6px) scale(.5);}
.ein-btn-primary::after,.ein-btn-outline::after{bottom:0;right:0;border-bottom:2px solid;border-right:2px solid;transform:translate(-6px,6px) scale(.5);}
.ein-btn-primary:hover::before,.ein-btn-outline:hover::before{opacity:1;transform:translate(-8px,-8px) scale(1);}
.ein-btn-primary:hover::after,.ein-btn-outline:hover::after{opacity:1;transform:translate(8px,8px) scale(1);}

.ein-btn-primary{padding:14px;border:none;border-radius:12px;color:#fff;font-family:'Poppins',sans-serif;font-weight:600;font-size:13.5px;display:flex;align-items:center;justify-content:center;gap:8px;cursor:pointer;box-shadow:0 12px 22px -10px rgba(198,161,91,.4);transition:box-shadow .3s,transform .2s;}
.ein-btn-primary:hover{box-shadow:0 16px 30px -12px rgba(20,184,166,.5);transform:translateY(-2px);}
...
.ein-divider{position:relative;text-align:center;margin:16px 0;}
.ein-divider::before{content:"";position:absolute;top:50%;left:0;width:100%;height:1px;background:#eeece7;}
.ein-divider span{position:relative;background:#fff;padding:0 10px;font-size:11px;color:#9a978f;font-weight:500;}

.ein-btn-outline{display:block;text-align:center;padding:12px;border:2px solid var(--ein-navy);border-radius:12px;color:var(--ein-navy);font-family:'Poppins',sans-serif;font-weight:600;font-size:13px;text-decoration:none;transition:background .3s,color .3s,box-shadow .3s,transform .2s;}
.ein-btn-outline:hover{background:var(--ein-navy);color:#fff;box-shadow:0 10px 22px -10px rgba(65,82,109,.5);transform:translateY(-2px);}
.ein-btn-outline:active{transform:translateY(0);}

.ein-copyright{text-align:center;font-size:10.5px;color:#9a978f;margin-top:18px;}

@media (max-width:380px){
  .ein-card-body{padding:16px;}
  .ein-welcome h2{font-size:19px;}
  .ein-logo{width:46px;height:46px;}
}
</style>
</x-guest-layout>