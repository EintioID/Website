...
<style>
    ...
    /* ===== Cards ===== */
    .card-hover { transition: box-shadow .3s var(--ease-smooth), border-color .3s var(--ease-smooth); }
    .card-hover:hover { box-shadow: 0 20px 40px -20px rgba(15,23,42,0.16); border-color: rgba(20,184,166,0.25); }

    .team-table-card { border-radius: 1rem; transition: box-shadow .3s var(--ease-smooth), border-color .3s var(--ease-smooth); }

    /* ===== Sidebar Tab (edit page) ===== */
    ...
    /* ===== Table (index) — FIX: total lebar kolom pasti 100%, tidak ada sisa ruang aneh ===== */
    .services-table { width: 100%; border-collapse: collapse; table-layout: fixed; }
    .services-table col.col-no       { width: 60px; }
    .services-table col.col-name     { /* tanpa width = otomatis ambil sisa ruang */ }
    ...
    /* ===== Modal overlay via x-teleport — pastikan selalu full-screen ===== */
