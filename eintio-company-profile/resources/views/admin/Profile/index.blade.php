<x-app-layout>
    ...
    <style>
        ...
        /* ===== REVEAL SAAT PAGE LOAD, PER SECTION  ===== */
        @keyframes revealSectionIn {
            from { opacity: 0; transform: translateY(18px); }
            to   { opacity: 1; transform: translateY(0); }
        }
        .reveal-section {
            opacity: 0;
            animation: revealSectionIn 0.55s var(--ease-smooth) forwards;
        }
        ...
        .reveal-section[data-delay="5"] { animation-delay: 0.45s; }
        ...
        /* ===== MISI ROW ===== */
        .mission-row { border: 1px solid #E2E8F0; border-radius: 0.75rem; transition: border-color .3s var(--ease-smooth), background-color .3s var(--ease-smooth); }
        .mission-row:hover { border-color: #14B8A6; background-color: #fff; }
    ...
    <div x-data="profilePerusahaan()" class="space-y-8">
        ...
        @if(session('success'))
            <div x-data="{ show: true }" x-show="show" x-init="setTimeout(() => show = false, 4000)" x-transition
                 class="reveal-section flex items-center gap-3 bg-brand-mint/10 border border-brand-mint/30 text-brand-mint px-5 py-3.5 rounded-xl text-sm font-medium" data-delay="1">
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-slate-100">
            ...
            <div class="reveal-section px-8 py-7 border-b border-slate-100" data-delay="1">
            ...
            <form action="{{ route('admin.profile.update') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-[240px_1fr] gap-0">
                    ...
                    {{-- SECTION 2: Sidebar tab --}}
                    <div class="reveal-section border-b lg:border-b-0 lg:border-r border-slate-100 p-6 space-y-2" data-delay="2">
                    ...
                    {{-- SECTION 3: Konten tab --}}
                    <div class="reveal-section p-6 lg:p-12" data-delay="3">
